...
def main():
    ...
    run_1_status = run_cmd("python3 pipeline.py --business-date 2026-06-28 --run-id RUN_ID_001")
    ...
    run_2_status = run_cmd("python3 pipeline.py --business-date 2026-06-28 --run-id RUN_ID_002")
